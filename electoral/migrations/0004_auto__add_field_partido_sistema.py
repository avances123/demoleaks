...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Partido.sistema'
        db.add_column('electoral_partido', 'sistema', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='partidos', to=orm['electoral.Sistema']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Partido.sistema'
        db.delete_column('electoral_partido', 'sistema_id')
