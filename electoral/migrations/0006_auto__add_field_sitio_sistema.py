...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sitio.sistema'
        db.add_column('electoral_sitio', 'sistema', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sitios', to=orm['electoral.Sistema']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sitio.sistema'
        db.delete_column('electoral_sitio', 'sistema_id')
    ...
    models = {
        ...
        'electoral.sitio': {
            ...
            'sistema': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sitios'", 'to': "orm['electoral.Sistema']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'db_index': 'True'}),
