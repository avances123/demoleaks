...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sitio.demoleak'
        db.add_column('electoral_sitio', 'demoleak', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Partido.demoleak'
        db.add_column('electoral_partido', 'demoleak', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sitio.demoleak'
        db.delete_column('electoral_sitio', 'demoleak')

        # Deleting field 'Partido.demoleak'
        db.delete_column('electoral_partido', 'demoleak')
    ...
    models = {
        ...
        'electoral.partido': {
            'Meta': {'ordering': "['-votos_numero', 'sitio']", 'object_name': 'Partido'},
            'demoleak': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'nombre_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'nombre_es': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'sistema': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'partidos'", 'to': "orm['electoral.Sistema']"}),
