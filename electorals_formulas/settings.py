...
# Change the test database to sqlite3
...
# Set that numeric fields are shown with locale specific thousand separator
# in the templates. You can avoid this by converting the data to string or
# by using the "|unlocalize" filter.
...
SECRET_KEY = 'ovbbb=kblqy4jgoz#v+_7k!wjh3c66burf_q4xnx7_#u%-2m+k'
